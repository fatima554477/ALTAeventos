...
<strong><p class="mb-0 text-uppercase" style="font-size:22px;">&nbsp;EVENTOS </p> </strong> </div> 	    
...
<span style="font-size:22px;">&nbsp;&nbsp;NOMBRE CORTO DEL EVENTO:
<?php echo  isset($NOMBRE_CORTO_EVENTO)?' '.$NOMBRE_CORTO_EVENTO:'';?> </p> </strong> </div>
